...
struct Utility {
    ...
    //MARK: - Set Root WelcomeVC Method
    func setRootWelcomeVC() {
        let objMoviesListVC = AllStoryBoard.Main.instantiateViewController(withIdentifier: ViewControllerName.kMoviesListVC) as? MoviesListVC
        let navigationViewController = UINavigationController(rootViewController: objMoviesListVC!)
